      ...
      <main className="w-full max-w-md px-6 py-12 z-10">
        ...
        <div className="glass-panel border border-outline-variant/15 p-8 rounded-xl whisper-shadow">
          <header className="mb-8 text-center md:text-left">
            <h2 className="font-arthaku-headline text-2xl font-bold text-primary">Masuk ke ArthaKu</h2>
            <p className="text-sm text-on-surface-variant mt-1">Masukkan kredensial Anda untuk mengakses akun.</p>
          </header>
          ...
          <form className="space-y-6" onSubmit={handleManualLogin}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="block text-xs font-semibold uppercase tracking-widest text-on-surface-variant/80" htmlFor="password">
                  Kata Sandi
                </label>
                <a className="text-[10px] font-bold text-primary hover:text-secondary transition-colors uppercase tracking-widest" href="#">Lupa Sandi?</a>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-on-surface-variant/60 group-focus-within:text-secondary transition-colors">
          ...
          <div className="mt-8 pt-8 border-t border-outline-variant/10 text-center">
            <p className="text-sm text-on-surface-variant">
              Belum punya akun? 
              <Link className="text-primary font-bold hover:text-secondary transition-colors ml-1" to="/register">Daftar</Link>
            </p>
          </div>
        </div>
