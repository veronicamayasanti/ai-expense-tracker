          ...
          >
            <div className="relative z-10">
              ...
              <div className="flex items-baseline gap-1.5 md:gap-2">
                <span className="text-3xl md:text-5xl font-extrabold text-primary tracking-tight">Rp</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              <div className="bg-white p-5 md:p-6 rounded-2xl border border-slate-100 flex items-center justify-between shadow-sm">
                <div className="flex flex-col">
                  ...
                  <span className="text-xl md:text-2xl font-black text-emerald-800">Rp {stats.totalIncome.toLocaleString()}</span>
                </div>
              ...
              <div className="bg-white p-5 md:p-6 rounded-2xl border border-slate-100 flex items-center justify-between shadow-sm">
                <div className="flex flex-col">
                  ...
                  <span className="text-xl md:text-2xl font-black text-rose-800">Rp {stats.totalExpense.toLocaleString()}</span>
                </div>
